# One file per Grafana account, generated by bin/sync.sh from the orgs map
# in instance.auto.tfvars — do not edit or copy by hand; the sync rewrites
# these files and page.tf's lists on every run. Provider configurations
...
# its credentials — follows from its key in the data files.
